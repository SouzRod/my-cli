module.exports = name =>  [
  ...
  { path: `v1/controllers/${name}Controller.js`, template: 'v1.controllers.sampleController.ejs' },
  { path: 'v1/schemas/index.js', template: 'v1.schemas.index.ejs' },
  { path: `v1/schemas/${name}Schema.js`, template: 'v1.schemas.sampleSchema.ejs' },
